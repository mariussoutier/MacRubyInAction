...
class AppDelegate
  ...
  def add_image(sender)
    ...
    # Book example does not work in 0.10 because of proc crash, will be fixed in 0.11
    ...
    #}
    #panel.beginSheetModalForWindow @window, completionHandler:proc
